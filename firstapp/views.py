...
def crm_dashboard(request):
    ...
    return render(request, "index.html", {"statuses": statuses.values(), "customers": customers})
...
def add_customer(request):
    if request.method == "POST":
        ...
        if name and contact and email and opportunity:
            Customer.objects.create(
                name=name, contact=contact, email=email, opportunity=opportunity
            )
...
def update_status(request):
    if request.method == "POST":
        ...
        try:
            ...
            customer.status_display = new_status
            customer.save()
